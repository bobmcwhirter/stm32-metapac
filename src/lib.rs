#![no_std]
#![doc = "Peripheral access API (generated using svd2rust v0.17.0 (d20b709 2021-04-11))"]
pub mod dma_v2 {
    use crate::generic::*;
    ...
    impl Dma {
        ...
        pub fn isr(self, n: usize) -> Reg<regs::Isr, R> {
            assert!(n < 2usize);
            unsafe { Reg::from_ptr(self.0.add(0usize + (n as u32) * 4u32)) }
        }
        #[doc = "low interrupt flag clear register"]
        pub fn ifcr(self, n: usize) -> Reg<regs::Ifcr, W> {
            assert!(n < 2usize);
            unsafe { Reg::from_ptr(self.0.add(8usize + (n as u32) * 4u32)) }
        }
        #[doc = "Stream cluster: S?CR, S?NDTR, S?M0AR, S?M1AR and S?FCR registers"]
        pub fn st(self, n: usize) -> St {
            assert!(n < 8usize);
            unsafe { St(self.0.add(16usize + (n as u32) * 24u32)) }
        }
    }
    pub mod regs {
        use crate::generic::*;
        ...
        impl Fcr {
            ...
            pub fn set_fs(&mut self, val: super::vals::Fs) {
                self.0 = (self.0 & !(0x07 << 3u32)) | (((val.0 as u32) & 0x07) << 3u32);
            }
        ...
        impl Cr {
            ...
            pub fn set_dir(&mut self, val: super::vals::Dir) {
                self.0 = (self.0 & !(0x03 << 6u32)) | (((val.0 as u32) & 0x03) << 6u32);
            }
            #[doc = "Circular mode"]
            ...
            pub const fn pinc(&self) -> super::vals::Minc {
                let val = (self.0 >> 9u32) & 0x01;
                super::vals::Minc(val as u8)
            }
            #[doc = "Peripheral increment mode"]
            pub fn set_pinc(&mut self, val: super::vals::Minc) {
                self.0 = (self.0 & !(0x01 << 9u32)) | (((val.0 as u32) & 0x01) << 9u32);
            }
            #[doc = "Memory increment mode"]
            pub const fn minc(&self) -> super::vals::Minc {
                let val = (self.0 >> 10u32) & 0x01;
                super::vals::Minc(val as u8)
            }
            #[doc = "Memory increment mode"]
            pub fn set_minc(&mut self, val: super::vals::Minc) {
                self.0 = (self.0 & !(0x01 << 10u32)) | (((val.0 as u32) & 0x01) << 10u32);
            }
            #[doc = "Peripheral data size"]
            pub const fn psize(&self) -> super::vals::Msize {
                let val = (self.0 >> 11u32) & 0x03;
                super::vals::Msize(val as u8)
            }
            #[doc = "Peripheral data size"]
            pub fn set_psize(&mut self, val: super::vals::Msize) {
                self.0 = (self.0 & !(0x03 << 11u32)) | (((val.0 as u32) & 0x03) << 11u32);
            }
            #[doc = "Memory data size"]
            pub const fn msize(&self) -> super::vals::Msize {
                let val = (self.0 >> 13u32) & 0x03;
                super::vals::Msize(val as u8)
            }
            #[doc = "Memory data size"]
            pub fn set_msize(&mut self, val: super::vals::Msize) {
                self.0 = (self.0 & !(0x03 << 13u32)) | (((val.0 as u32) & 0x03) << 13u32);
            }
            ...
            pub fn set_dbm(&mut self, val: super::vals::Dbm) {
                self.0 = (self.0 & !(0x01 << 18u32)) | (((val.0 as u32) & 0x01) << 18u32);
            }
            ...
            pub fn set_ct(&mut self, val: super::vals::Ct) {
                self.0 = (self.0 & !(0x01 << 19u32)) | (((val.0 as u32) & 0x01) << 19u32);
            }
            #[doc = "Peripheral burst transfer configuration"]
            pub const fn pburst(&self) -> super::vals::Mburst {
                let val = (self.0 >> 21u32) & 0x03;
                super::vals::Mburst(val as u8)
            }
            #[doc = "Peripheral burst transfer configuration"]
            pub fn set_pburst(&mut self, val: super::vals::Mburst) {
                self.0 = (self.0 & !(0x03 << 21u32)) | (((val.0 as u32) & 0x03) << 21u32);
            }
            #[doc = "Memory burst transfer configuration"]
            pub const fn mburst(&self) -> super::vals::Mburst {
                let val = (self.0 >> 23u32) & 0x03;
                super::vals::Mburst(val as u8)
            }
            #[doc = "Memory burst transfer configuration"]
            pub fn set_mburst(&mut self, val: super::vals::Mburst) {
                self.0 = (self.0 & !(0x03 << 23u32)) | (((val.0 as u32) & 0x03) << 23u32);
            }
            #[doc = "Channel selection"]
            pub const fn chsel(&self) -> u8 {
                let val = (self.0 >> 25u32) & 0x0f;
                val as u8
            }
            #[doc = "Channel selection"]
            pub fn set_chsel(&mut self, val: u8) {
                self.0 = (self.0 & !(0x0f << 25u32)) | (((val as u32) & 0x0f) << 25u32);
            }
        }
        impl Default for Cr {
            fn default() -> Cr {
        ...
        impl Ifcr {
            ...
            pub fn cfeif(&self, n: usize) -> bool {
                assert!(n < 4usize);
                let offs = 0u32 + [0u32, 6u32, 16u32, 22u32][n];
            ...
            pub fn cdmeif(&self, n: usize) -> bool {
                assert!(n < 4usize);
                let offs = 2u32 + [0u32, 6u32, 16u32, 22u32][n];
                let val = (self.0 >> offs) & 0x01;
                val != 0
            }
            #[doc = "Stream x clear direct mode error interrupt flag (x = 3..0)"]
            ...
            pub fn cteif(&self, n: usize) -> bool {
                assert!(n < 4usize);
                let offs = 3u32 + [0u32, 6u32, 16u32, 22u32][n];
                let val = (self.0 >> offs) & 0x01;
                val != 0
            }
            #[doc = "Stream x clear transfer error interrupt flag (x = 3..0)"]
            ...
            pub fn chtif(&self, n: usize) -> bool {
                assert!(n < 4usize);
                let offs = 4u32 + [0u32, 6u32, 16u32, 22u32][n];
                let val = (self.0 >> offs) & 0x01;
                val != 0
            }
            #[doc = "Stream x clear half transfer interrupt flag (x = 3..0)"]
            ...
            pub fn ctcif(&self, n: usize) -> bool {
                assert!(n < 4usize);
                let offs = 5u32 + [0u32, 6u32, 16u32, 22u32][n];
                let val = (self.0 >> offs) & 0x01;
                val != 0
            }
            #[doc = "Stream x clear transfer complete interrupt flag (x = 3..0)"]
    ...
    pub mod regs {
        ...
        impl Memrm {
            ...
            pub const fn swp_fmc(&self) -> u8 {
                let val = (self.0 >> 10u32) & 0x03;
                val as u8
            }
            #[doc = "FMC memory mapping swap"]
            pub fn set_swp_fmc(&mut self, val: u8) {
                self.0 = (self.0 & !(0x03 << 10u32)) | (((val as u32) & 0x03) << 10u32);
            }
        }
...
pub mod timer_v1 {
    ...
    impl TimGp32 {
        ...
        pub fn ccmr_input(self, n: usize) -> Reg<regs::CcmrInput, RW> {
            assert!(n < 2usize);
            unsafe { Reg::from_ptr(self.0.add(24usize + (n as u32) * 4u32)) }
        }
        ...
        pub fn ccr(self, n: usize) -> Reg<regs::Ccr32, RW> {
            assert!(n < 4usize);
            unsafe { Reg::from_ptr(self.0.add(52usize + (n as u32) * 4u32)) }
        }
...
pub mod dma_v1 {
    ...
    impl Dma {
        ...
        pub fn ch(self, n: usize) -> Ch {
            assert!(n < 7usize);
            unsafe { Ch(self.0.add(8usize + (n as u32) * 20u32)) }
        }
    }
    pub mod regs {
        use crate::generic::*;
        ...
        impl Cr {
            ...
            pub fn set_msize(&mut self, val: super::vals::Size) {
                self.0 = (self.0 & !(0x03 << 10u32)) | (((val.0 as u32) & 0x03) << 10u32);
            }
...
pub mod gpio_v2 {
    ...
    impl Gpio {
        ...
        pub fn afr(self, n: usize) -> Reg<regs::Afr, RW> {
            assert!(n < 2usize);
            unsafe { Reg::from_ptr(self.0.add(32usize + (n as u32) * 4u32)) }
        }
    }
    pub mod regs {
        use crate::generic::*;
