#![no_std]
#![doc = "Peripheral access API (generated using svd2rust v0.17.0 (5ad01b7 2021-04-05))"]
pub mod gpio_v2 {
    use crate::generic::*;
...
pub mod timer_v1 {
    ...
    impl TimAdv {
        ...
        #[doc = "counter"]
        pub fn cnt(self) -> Reg<regs::Cnt, RW> {
        ...
        pub fn arr(self) -> Reg<regs::Arr, RW> {
        ...
        pub fn ccr(self, n: usize) -> Reg<regs::Ccr, RW> {
            assert!(n < 4usize);
    ...
    #[derive(Copy, Clone)]
    pub struct TimGp(pub *mut u8);
    unsafe impl Send for TimGp {}
    unsafe impl Sync for TimGp {}
    impl TimGp {
        #[doc = "control register 1"]
        pub fn cr1(self) -> Reg<regs::Cr1, RW> {
            unsafe { Reg::from_ptr(self.0.add(0usize)) }
